...
// Mostrar mensaje si está configurado
    ...
    <section class="table-section">
        <div class="table-container">
            <h1 class="titulo-tabla">Gestión de Usuarios:</h1>
            <div class="table-header">
                <button class="add-user-button" title="Agregar Usuario" id="addUserButton">+</button>
            </div>
                        ...
                        <?php while($row = $result->fetch_assoc()): ?>
                            <tr id="user-<?php echo $row['id']; ?>">
                                ...
                                <td class="action-buttons">
                                    <button class="btn-modificar" onclick="window.location.href='user_form.php?id=<?php echo $row['id']; ?>'">Modificar</button>
