...
// Verificamos si el stock llegó a cero
...
foreach ($carrito as $producto) {
    ...
    $productoTotal = $productoPrecio * $productoCantidad;
    ...
    // Puedes usar estos valores para mostrar los productos en el recibo, y también calcular el total
    $total += $productoTotal; // Sumamos el total de la compra
}
	...
	<table class="bill-container">
		<tr class="bill-emitter-row">
			<td>
				...
				<div class = "logo">
					<img src="../uploads/Logo.jpg" alt="PROTON S.A.">
				</div>
				<p><strong>Razón social:</strong> Proton S.A.</p>
			...
			<td>
				<div>
					...
					<p><strong>Fecha de Emisión:</strong> <?php 
		...
		<tr class="bill-row">
			<td colspan="2">
				<div>
					<div class="row">
						<p class="col-4 margin-b-0 COLUMN">
						...
						<p class="col-8 margin-b-0">
							<strong>Apellido y Nombre / Razón social: </strong><?php echo $nombreusuario?>
						</p>
					</div>
					<div class="row">
						<p class="col-6 margin-b-0">
					...
					<p>
						...
						<?php
							...
							$medio_de_pago= ['Efectivo','Transferencia', 'Tarjeta'];
							$condicion_venta = array_rand($medio_de_pago);
							echo $medio_de_pago[$condicion_venta];
